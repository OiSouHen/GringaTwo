...
vRP.prepare("vRP/count_homepermissions","SELECT COUNT(home) AS qtd FROM vrp_homes WHERE home = @home")
vRP.prepare("vRP/count_homes","SELECT COUNT(home) AS qtd FROM vrp_homes WHERE user_id = @user_id")
