...
vRP.prepare("vRP/update_nationality","UPDATE users SET loc = 'Norte' WHERE loc = 'Sul' AND id = @id")
...
vRP.prepare("vRP/update_premium","UPDATE infos SET predays = predays + @predays, priority = @priority WHERE steam = @steam")
-----------------------------------------------------------------------------------------------------------------------------------------
-- PREPARE HOMES
-----------------------------------------------------------------------------------------------------------------------------------------
