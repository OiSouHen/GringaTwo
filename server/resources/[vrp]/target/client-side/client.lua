...
Citizen.CreateThread(function()
	...
	AddBoxZone("servicePolice02",vector3(1853.90,3689.89,34.26),0.3,0.3,{
		name = "servicePolice02",
		heading = 297,
		debugPoly = false,
		minZ = 34.06,
		maxZ = 34.46
	...
	AddBoxZone("servicePolice03",vector3(-449.48,6013.20,31.71),0.4,0.3,{
		name = "servicePolice03",
		heading = 45.36,
		debugPoly = false,
		minZ = 31.41,
		maxZ = 31.81
	...
	AddBoxZone("servicePolice04",vector3(1840.50,2578.26,46.02),0.3,0.4,{
		name = "servicePolice04",
		heading = 357.17,
		debugPoly = false,
		minZ = 45.59,
		maxZ = 45.99
		...
		options = {
			{
				event = "player:serviceCorrections",
				label = "Entrar/Sair de serviço",
				tunnel = "server"
			}
		}
	...
	AddBoxZone("serviceParamedic01",vector3(-254.39,6330.36,32.42),0.2,0.4,{
		name = "serviceParamedic01",
		heading = 130.4,
		debugPoly = false,
		minZ = 32.12,
		maxZ = 32.82
	...
	AddBoxZone("serviceParamedic02",vector3(1832.21,3677.25,34.27),0.3,0.2,{
		name = "serviceParamedic02",
		heading = 65.2,
		debugPoly = false,
		minZ = 34.17,
		maxZ = 34.57
	...
	AddBoxZone("serviceParamedic03",vector3(307.52,-595.34,44.28),0.4,0.4,{
		name = "serviceParamedic03",
		heading = 252.29,
		debugPoly = false,
		minZ = 42.79,
		maxZ = 43.89
	...
	AddBoxZone("serviceParamedic04",vector3(350.43,-587.49,28.8),0.4,0.4,{
		name = "serviceParamedic04",
		heading = 65.2,
		debugPoly = false,
		minZ = 27.8,
		maxZ = 29.8
	...
	AddBoxZone("bolingTreatment",vector3(1768.98,2571.01,45.73),0.4,0.4,{
		name = "bolingTreatment",
		heading = 311.82,
		debugPoly = false,
		minZ = 44.73,
		maxZ = 46.73
